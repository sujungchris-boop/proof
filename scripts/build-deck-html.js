...
<style>
:root{color-scheme:dark;--r-background-color:#121212;--bg:#121212;--bg2:#222222;--ink:#0E0E0A;--w:#FBF9F4;--w2:#E2DFD7;--mut:#B4B2AA;--line:#444;--lime:#D6FF3F;--mag:#FF52A6;--blue:#7FA6FF;--fn:'Fraunces',Georgia,serif;--fm:'IBM Plex Mono',monospace;--fb:'Manrope',system-ui,sans-serif}
/* force dark bg on every container so the deck never renders on white (CDN/extension proof) */
html,body,.reveal-viewport,.reveal,.reveal .backgrounds,.reveal .slides{background-color:#121212!important}
...
.reveal h1,.reveal h2,.reveal h3{font-family:var(--fn);font-weight:600;font-optical-sizing:none;font-variation-settings:'opsz' 16;color:var(--w);text-transform:none;margin:0;letter-spacing:-.012em;line-height:1.0}
.big,.case-body h2,.cover h1,.contact h1,.kbw,.pkgh{font-weight:700}
.reveal p{margin:0}
...
.card-tx{position:relative;padding:22px;z-index:2}.card-tx h3{font-size:22px;margin-bottom:9px;line-height:1.05}.card-tx p{font-size:13.5px;color:var(--w2);line-height:1.4}
/* WHY pillars */
